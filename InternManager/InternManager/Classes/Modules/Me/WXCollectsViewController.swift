//
//  WXCollectsViewController.swift
//  InternManager
//
...
class WXCollectsViewController: RootViewController {
    ...
    override func loadServerData() {
        ...
        NetworkManager.providerUserApi
            .request(.getCollects(user_id: user_id, page: page))
...
extension WXCollectsViewController: UITableViewDelegate,UITableViewDataSource {
